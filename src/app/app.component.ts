...
export class AppComponent implements OnInit {
	...
	public ngOnInit(): void {
		...
		const items = new DataSet([
			{ id: 1, content: 'item 1', title: 'title 1', start: '2013-04-20', group: 1, className: 'inpatientItem' },
			{ id: 2, content: 'item 2', start: '2013-04-14', group: 3, className: 'midwifeItem' },
			{ id: 3, content: 'item 3', start: '2013-04-18', group: 4, className: 'deliverItem'},
